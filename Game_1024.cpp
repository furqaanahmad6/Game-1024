...
int main()
{
	...
	while (1)
	{
		...
		system("cls");
		if (ch == 72) swipeup(a);
		if (ch == 80) swipedown(a);
		if (ch == 75) swipeleft(a);
		if (ch == 77) swiperight(a);
		if (ch == 27) break;
